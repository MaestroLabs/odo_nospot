module ApplicationHelper
 ...
 def youtube_embed(youtube_url)
  if youtube_url[/youtu\.be\/([^\?]*)/]
    ...
    %Q{<div class="iframe-percent"><iframe title="YouTube video player" src="http://www.youtube.com/embed/#{ youtube_id }?enablejsapi=1" frameborder="0" allowfullscreen></iframe></div>}
 end
